...
/**
* 矩形裁剪框： setInitCropRect()初始裁剪框位置，getCropAttrs()获得裁剪框对应的四点
* @Author: Adolf
* @Date: 2020-09
*/
public class RectCropView extends androidx.appcompat.widget.AppCompatImageView {
    ...
    public RectCropView(Context context, AttributeSet attrs, int defStyle) {
